...
Translate the coefficient on `log_income` into percentage changes that a reader
can recognize.
...
Write both interpretations as pooled associations among observations in the
same included current income-level category. Causal interpretation requires a
